    ...
    <div name='about' className='w-full h-full bg-gradient-to-b from-gray-700 to-black text-white'>
        <div className='max-w-screen-lg mx-auto py-12 px-4 flex flex-col justify-center w-full h-full lg:pl-20 xl:pl-0 '>
            ...
            <p className='text-xl'>
                  ...
                  For front-end, I am proficient in HTML, CSS, JavaScript, and modern frameworks like React. I also have experience with design tools such as Tailwind and Bootstrap, which help me craft responsive and visually appealing user interfaces.  On the back-end, I specialize in Django and Python, leveraging their powerful capabilities to build dynamic and secure server-side applications. I am well-versed in database management with MySQL, ensuring data integrity and optimal performance.
            </p>
